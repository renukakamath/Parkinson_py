...
public class Inter_chat_immigration extends AppCompatActivity implements JsonResponse {
    EditText ed1;
    ImageView b1;
    String chat;
    ListView l1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inter_chat_immigration);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (chat.equalsIgnoreCase("")) {
                    ...
                    JR.json_response = (JsonResponse) Inter_chat_immigration.this;
                    String q = "/chat?sender_id=" + sh.getString("log_id", "") + "&receiver_id=" + UserViewDoctors.doctor_id+ "&details=" + chat;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
                }
    ...
    void getChats() {
        ...
        JsonReq JR = new JsonReq();
        JR.json_response = (JsonResponse) Inter_chat_immigration.this;
        String q = "/chatdetail?sender_id=" + sh.getString("log_id", "") + "&receiver_id=" +UserViewDoctors.doctor_id;
        q = q.replace(" ", "%20");
