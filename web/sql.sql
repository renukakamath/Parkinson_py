...
insert  into `bookings`(`book_id`,`schedule_id`,`patient_id`,`date_time`,`status`) values (1,1,1,'07/04/2023','booked');
...
insert  into `chat`(`chat_id`,`sender_id`,`sender_type`,`receiver_id`,`receiver_type`,`message`,`date_time`) values (1,5,'doctor',6,'user','hai','2023-04-08 00:35:45');
...
insert  into `login`(`login_id`,`username`,`password`,`usertype`) values (1,'admin','admin','admin'),(2,'pharmacy1@gmail.com','8976787678','pharmacy'),(6,'anu@gmail.com','9898787878','user'),(4,'ammu1111@gmail.com','6235326868','doctor'),(5,'aleena@gmail.com','8787676767','doctor'),(7,NULL,NULL,NULL);
...
insert  into `medical_notes`(`medical_note_id`,`booking_id`,`description`,`date_time`) values (1,1,'fdsgfdg','2023-04-07 22:42:24');
...
insert  into `medicine_prescriptions`(`med_pres_id`,`book_id`,`medicine_id`,`date_time`,`med_pres_description`,`status`) values (1,1,1,'2023-04-07 22:35:17','fgfg','Accept');
...
insert  into `patients`(`patient_id`,`user_id`,`first_name`,`last_name`,`phone`,`email`,`house_name`,`place`,`gender`,`blood_group`,`dob`) values (1,1,'anna','rose','9998898989','anna@gmail.com','kalarikkal','kochi','female','O+ve','12/03/1998');
...
insert  into `payments`(`pay_id`,`book_id`,`amount`,`payment_date`,`payment_type`) values (1,1,100,'2023-04-08','Medicne');
...
insert  into `physical_conditions`(`physical_condition_id`,`patient_id`,`blood_pressure`,`sugar`,`cholesterol`,`height`,`weight`,`date_time`) values (1,1,'100','210','100','160','200','12/2/23');
...
insert  into `user`(`user_id`,`login_id`,`fname`,`lname`,`place`,`phone`,`email`) values (1,6,'anu','mary','kochi','9898989898','anu@gmail.com');
